...
class Calculator:
    ...
    # Binding buttons of the calculator to the keyboard
    def bind_keys(self):
    ...
    # Creating labels for the current expression and total expression
    ...
    # Creating the operators buttons
    ...
    # creating the frame of the buttons
    def create_buttons_frame(self):
        frame = tk.Frame(self.window)
        frame.pack(expand=True, fill="both")
        return frame

    # Update total label and changing the operator symbols
    ...
    # Update label of current expression
